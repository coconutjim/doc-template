...
RichEdit1->SelLength=uuu;
if (Form3->ADOTable2->FieldByName("size1")->Value!=0)
{
RichEdit1->SelAttributes->Size=Form3->ADOTable2->FieldByName("size1")->Value;
}
RichEdit1->SelAttributes->Style=TFontStyles(Form3->ADOTable2->FieldByName("style")->Value);
if (k>=uuu)
{
c2.Delete(uuu+1,k-uuu);
}
if (uuu>k)
{
ooo=uuu-k;
...
Form5->StringGrid1->Cells[0][0]="Код документа";
Form5->StringGrid1->Cells[1][0]="Имя документа";
Form5->StringGrid1->Cells[2][0]="Код семантики";
Form5->StringGrid1->Cells[3][0]="Семантика";
Form5->StringGrid1->Cells[4][0]="Начало";
Form5->StringGrid1->Cells[5][0]="Конец";
Form5->StringGrid1->Cells[6][0]="Длина";
Form5->StringGrid1->Cells[7][0]="Код версии";
Form5->StringGrid1->Cells[8][0]="Имя версии";
Form5->StringGrid1->Cells[9][0]="Значение семантики";
...
mn123=Form3->ADOTable3->FieldByName("VersCode")->Value;
if (mn123==iiii1)
{
